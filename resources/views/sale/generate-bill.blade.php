        ...
        <div class="col-xs-6">
            ...
            <div class="row">
                <div class="col-xs-7">
                    ...
                    <p class="m-0">Customer:
                        <b>{{$customer}}</b>
                    </p>
                    <p class="m-0">Sale Person:
                        <b>{{$person}}</b>
                    </p>
                </div>
                <div class="col-xs-5">
            ...
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td>
                        <?php echo App\Models\Product\Product::where('id',$s['product_id'])->first(['name'])->name; ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <span class="">
                            <?php $disc = $dis / count($sales); echo number_format($disc,2); ?>% discount</span>
                    </td>
                    <td class="text-right"></td>
                    <td class="text-right"></td>
                    <td class="text-right">
                        <?php $less =  $total - $dtotal; ?> {{number_format($less,2)}}</td>
                </tr>
                <?php endif; ?>
            </table>
            ...
            <div>
                <span class="pull-right net-amount ">
                    <b>
                        <?php echo number_format($dtotal,2) ?> </b>
                </span>
                <span class="pull-right net-text">
                    <b>Net Amount:</b>
                </span>
            </div>
